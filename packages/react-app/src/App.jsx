    ...
    <div className="App">
      ...
      <Footer style={{ textAlign: "center", fontSize: "16px" }}>
        <Space>
         ...
         {cre8rScore ? <span>Your CRE8R Holdings across Fantom Pools and Vaults ${Math.round(cre8rScore*0.42)}</span> : <span> Connect a wallet that voted to view your CRE8R Voting Power</span>}
         {beetsScore ? <span>Your $FBEETS voting power {Math.round(beetsScore)}</span> : <span> Connect a wallet that voted to view your CRE8R Voting Power</span>}
